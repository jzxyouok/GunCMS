...
<script type="text/javascript">
    $(document).ready(function () {
		$("#LogInGoods_Form").validation(); 	
        $("#LogInGoods_Submit").click(function () {
			if ($("form").valid()==false){//验证不通过
			   return false;
				...
				var options = {
					...
					type: 'post',
					dataType: 'text',
					data: $("#LogInGoods_Form").serialize(),
...
<div class="container">    
<form role="form" action="./inc/views.php" method="post" id="LogInGoods_Form">
	<fieldset>
      <div id="legend" class="">
        <legend class="">采购入库</legend>
      </div>
	  ...
	  <p><input type="hidden" value="0" name="page" /></p>
	  <button type="submit" id="LogInGoods_Submit" class="btn btn-default">提交</button>
	  <p id="responseText"></p>
